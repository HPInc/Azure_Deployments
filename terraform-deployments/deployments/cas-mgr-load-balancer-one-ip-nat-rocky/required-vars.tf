...
variable "cac_count_list" {
  description = "Number of Cloud Access Connector instances to deploy in each location"
  type        = list(number)
}

variable "cac_location_list" {
  description = "Locations of Cloud Access Connector instances to deploy in"
  type        = list(string)
}
