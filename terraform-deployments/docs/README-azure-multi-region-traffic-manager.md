...
Once the workstations have been added to be managed by CAM and assigned to Active Directory users, users can connect through the PCoIP client using the domain name of the traffic manager.
