...
locals {
  windows_std_provisioning_script        = "aadds-std-provisioning.ps1" 
  windows_std_provisioning_script_params = "${var.pcoip_registration_code} ${var.domain_name} ${var.ad_service_account_username} ${local.ad_admin_password} ${var.application_id} ${var.aad_client_secret} ${var.enable_workstation_idle_shutdown} ${var.minutes_idle_before_shutdown} ${var.minutes_cpu_polling_interval}"
