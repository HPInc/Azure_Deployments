...
locals {
  ...
  windows_std_provisioning_script_params = "${var.pcoip_registration_code} ${var.domain_name} ${var.ad_service_account_username} ${local.ad_admin_password} ${var.application_id} ${var.aad_client_secret} ${var.tenant_id}"
